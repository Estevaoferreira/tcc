...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="bootstrap-root/dist/css/bootstrap.css" rel="stylesheet">
...
<body background="img/fundo/fundo-desk.png">
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="incluir.html">
          ...
          <form name="dados" method="post" action="validacao_inclusao.php">
            <p>
              <div class="form-floating">
                Nome: <p><input type="text" class="form-control" id="floatingInput" name="nome"></p>
              </div>
            </p>
            <p>
              <div class="form-floating">
                Preço: <p><input type="text" class="form-control" id="floatingInput" name="preco"></p>
              </div>
            </p>
            <p>
              <div class="form-floating">
            ...
            <p>
              <input class="w-100 btn btn-lg btn-primary" type="submit" name="acao" value="Incluir" >
              <input class="w-100 btn btn-lg btn-primary" type="submit" value="Cancelar" name="acao">
            </p>
          </form>
        </body>
        </html>
